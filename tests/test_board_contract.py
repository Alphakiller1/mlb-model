...
# The only per-repo line: where this product keeps its copies.
_VENDORED = {
    "board.py": _REPO / "mlbmodel" / "report" / "board.py",
    "board.css": _REPO / "mlbmodel" / "report" / "static" / "board.css",
    "chase_tokens.css": _REPO / "mlbmodel" / "report" / "static" / "chase_tokens.css",
    "chase-tokens-v1.css": _REPO / "mlbmodel" / "report" / "static" / "chase-tokens-v1.css",
}
