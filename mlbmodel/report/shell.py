...
.pagehead h2{font-family:var(--display);font-weight:800;font-size:var(--mm-text-display);font-variation-settings:'wdth' 125;letter-spacing:-.02em;margin:0 0 5px;line-height:1.05}
